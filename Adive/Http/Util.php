...
class Util
{
     ...
     * @param  \Adive\Http\Headers $headers The Response headers
     * @param  \Adive\Http\Cookies $cookies The Response cookies
     * @param  array              $config  The Adive app settings
     */
    public static function serializeCookies(\Adive\Http\Headers &$headers, \Adive\Http\Cookies $cookies, array $config)
    {
     ...
     *
     * This method will construct and set the HTTP `Set-Cookie` header. Adive
     ...
     * is already set in the HTTP response, it will also be removed. Adive uses this method
