...
<form class="form-horizontal" method="post">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
        ...
        <input id="field_file_<?=$value['name']?>" name="field_file_<?=$value['name']?>" value="" type="file" class="form-control file-loading" accept="image/*" onchange="var wholePIC = this.value; var splitPIC = wholePIC.split("."); $(#field_<?=$value['name']?>).val(splitPIC[1]+"_<?=$_SESSION['adive.time']?>."+splitPIC[2]);">
        <script>
